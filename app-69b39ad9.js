...
/***/ function(module, exports, __webpack_require__) {
	...
	var _code = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Resizer = __webpack_require__(84);
	...
	var _Console = __webpack_require__(80);
	...
	var _LayoutSwitch = __webpack_require__(83);
	...
	exports.default = {
		...
		onSidebarResize: function onSidebarResize(e) {
			// console.log( e );
			this.data.sidebarWidth = this.data.sidebarWidth + e.offsetX;
		},
		config: function config() {
			this.data.sidebarWidth = 230;
		},
		init: function init() {
	...
	exports.default = {
		...
		init: function init() {
			...
			function onMousemove(e) {
				...
				self.$emit('resize', {
					offsetX: e.pageX - initPos.x,
					offsetY: e.pageY - initPos.y
				});
			}
