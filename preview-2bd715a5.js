	...
	var Play = function () {
		...
		_createClass(Play, [{
			...
			value: function add(description, template) {
				...
				// expose
				var m = this.m;
				var displayName = this.displayName || actorName;
				m.exports.actors = m.exports.actors || {};
				m.exports.actors[actorName] = m.exports.actors[actorName] || [];
				m.exports.actors[actorName].push({
					displayName: displayName || actorName, name: actorName, description: description, Spot: Spot, code: code
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _play2.default)(_Button2.default, module).name('Button').displayName('Input and Button').component('Input', _Input2.default).add('input and button', {
		...
		onSubmit: function onSubmit() {
			this.$log('Submit ' + this.data.name);
		}
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37)(module)))
