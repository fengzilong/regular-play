...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playEntry = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getCtor = __webpack_require__(39);
		...
		_createClass(Play, [{
			...
			value: function add(description, template) {
				...
				if ((typeof template === 'undefined' ? 'undefined' : _typeof(template)) === 'object') {
					template.template = template.template.trim();
				...
				m.exports.actors[displayName].push({
					displayName: displayName, name: actorName, description: description, Spot: Spot, code: code
				});
