...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./reo/actions\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		init: function init() {
			this.data.layout = this.$router.current.param.layout || 'desktop';
		...
		onRouteChange: function onRouteChange() {
			...
			this.data.layout = this.$router.current.param.layout;
			console.log('layout', this.$router.current);
			this.$update();
		}
	};
...
/***/ function(module, exports) {
	...
	exports.default = {
		...
		onNav: function onNav(_ref) {
			...
			var layout = this.$router.current.param.layout;
